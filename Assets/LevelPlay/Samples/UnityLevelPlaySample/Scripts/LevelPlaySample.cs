...
public class LevelPlaySample : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        LevelPlay.Init(appKey,adFormats:new []{com.unity3d.mediation.LevelPlayAdFormat.REWARDED, com.unity3d.mediation.LevelPlayAdFormat.BANNER, com.unity3d.mediation.LevelPlayAdFormat.INTERSTITIAL});
    ...
    void EnableAds()
    {
        ...
        IronSourceBannerEvents.onAdScreenPresentedEvent += BannerOnAdPresentedEvent;
        IronSourceBannerEvents.onAdScreenDismissedEvent += BannerOnAdDismissedEvent;
    ...
    void InterstitialOnAdLoadFailedEvent(IronSourceError error)
    {
        Debug.Log("unity-script: I got InterstitialOnAdLoadFailedEvent With Error " + error);
    }
    ...
    {
        Debug.Log("unity-script: I got InterstitialOnAdShowFailedEvent With InfoError " + error);
    }
    ...
    void BannerOnAdPresentedEvent(IronSourceAdInfo adInfo)
    {
        Debug.Log("unity-script: I got BannerOnAdPresentedEvent With AdInfo " + adInfo);
    }

    void BannerOnAdDismissedEvent(IronSourceAdInfo adInfo)
    {
        Debug.Log("unity-script: I got BannerOnAdDismissedEvent With AdInfoError " + adInfo);
    }
